...
public final class Settings {
    ...
    /**
     * @hide - Private call() method on SettingsProvider to read from 'kdp' table.
     */
    public static final String CALL_METHOD_GET_KDP = "GET_kdp";
    ...
    /** @hide - Private call() method to write to 'kdp' table */
    public static final String CALL_METHOD_PUT_KDP = "PUT_kdp";
    ...
    /**
     * KDP settings, containing KDP specific preferences.  This
     * table holds simple name/value pairs.  There are convenience
     * functions for accessing individual settings entries.
     */
    public static final class KDP extends NameValueTable {
        public static final String SYS_PROP_SETTING_VERSION = "sys.settings_system_version";
         ...
         */
        public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/kdp");
